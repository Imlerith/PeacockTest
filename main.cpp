...
// Description : client code for a 3d KS-type gof test
//============================================================================
...
int main() {
	...
	CSVReader reader_1("sample_1.csv"); // @suppress("Ambiguous problem")
	// CSVReader reader_2 = reader_1;
	CSVReader reader_2("sample_2.csv"); // @suppress("Ambiguous problem")
	...
	int ks_3d_stat = peacock3dim.get_peacock_3d_stat();
